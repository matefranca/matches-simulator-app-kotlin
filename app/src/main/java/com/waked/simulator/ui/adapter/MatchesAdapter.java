package com.waked.simulator.ui.adapter;
...
import com.waked.simulator.databinding.MatchItemBinding;
import com.waked.simulator.domain.Match;
import com.waked.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (match.getAwayTeam().getScore() != null){
            holder.binding.tvAwayTeamScore.setText(String.valueOf(match.getHomeTeam().getScore()));
        }
